...
public class subGoalCreation_goalSetting_edit_VC extends AppCompatActivity {

    private subGoalView_goalSetting_edit subGoalView;

    public subGoalCreation_goalSetting_edit_VC(subGoalView_goalSetting_edit subGoalView){
