package com.example.proccoli2.ui.mainProgress;
...
public class mainProgressView_VC extends AppCompatActivity {
     ...
     */
    public  ArrayList<BarEntry> generateBarEntries(ArrayList<com.example.proccoli2.NewModels.GoalModel> list){
    ...
    public ArrayList<String> generateXAxisLabel(ArrayList<com.example.proccoli2.NewModels.GoalModel> list){
    ...
    public double hourConverterForChart(double studiedTime){
        ...
        return roundOff;
         ...
         public void assignGoal(com.example.proccoli2.NewModels.GoalModel goal){
