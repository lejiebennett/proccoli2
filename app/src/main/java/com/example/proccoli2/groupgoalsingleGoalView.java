...
public class groupgoalsingleGoalView extends AppCompatActivity {
    ...
    groupgoalsingleGoalView_VC controller = new groupgoalsingleGoalView_VC(this);
    ...
    class reportProgressFullAdapter extends RecyclerView.Adapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
           ...
           // viewHolder.subGoalText.setTextColor(Color.WHITE);
           // viewHolder.subGoalText.setBackgroundColor(Color.DKGRAY);
        }
