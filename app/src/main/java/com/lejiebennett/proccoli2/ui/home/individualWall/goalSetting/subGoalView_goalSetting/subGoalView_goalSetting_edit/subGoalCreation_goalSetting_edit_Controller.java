 ...
 * Controller for editing previously made subgoal
 */
public class subGoalCreation_goalSetting_edit_Controller extends AppCompatActivity {

    private subGoalView_goalSetting_edit subGoalView;

    public subGoalCreation_goalSetting_edit_Controller(subGoalView_goalSetting_edit subGoalView){
    ...
    /**
     * Verifies date logic is held
     * @param start
     * @param complete
     * @param context
     * @param goalComplete
     * @return If the dates are illogical, return false since they failed the check, if they are logical return true
