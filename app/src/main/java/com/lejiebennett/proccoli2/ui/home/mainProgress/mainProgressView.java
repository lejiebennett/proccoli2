...
public class mainProgressView extends AppCompatActivity {
    ...
    ArrayList<com.lejiebennett.proccoli2.NewModels.GoalModel> activeList = new ArrayList<>();
    ArrayList<com.lejiebennett.proccoli2.NewModels.GoalModel> expiredList= new ArrayList<>();
    ArrayList<com.lejiebennett.proccoli2.NewModels.GoalModel> finishedList = new ArrayList<>();
        ...
        DataServices.getInstance().requestPersonalGoals(new ResultHandler<Object>() {
            ...
            public void onSuccess(Object data) {
                ...
                if (hashMap.get("_error") == null) {
                    ...
                    ArrayList<com.lejiebennett.proccoli2.NewModels.GoalModel> goalList = (ArrayList<com.lejiebennett.proccoli2.NewModels.GoalModel>) hashMap.get("_response");

                    for (com.lejiebennett.proccoli2.NewModels.GoalModel goal : goalList) {
