...
public class GoalModel implements Serializable{
    ...
    public GoalModel(String goalId, String bigGoal, int deadline, int createdAt, String goalType){
        this.goalId = goalId;
    ...
    public GoalModel(String goalId, String bigGoal, int deadline, int createdAt, String goalType,boolean isGraded){
        this.goalId = goalId;
        this.bigGoal = bigGoal;
        this.deadline = deadline;
        this.createdAt = createdAt;
...
//        this.goalId = goalId;
    ...
    public GoalModel(String bigGoal, int completedBy, String goalType, int startDate, int deadline, int createdAt,ArrayList<SubGoalModel> subgoals){
        this.bigGoal = bigGoal;
        this.completedBy = completedBy;
        this.goalType = goalType;
        this.startDate = startDate;
